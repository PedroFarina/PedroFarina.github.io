const highlights = [
    ...
    [
        ...
        {
            name: "Caderno Roxo",
            description: "O melhor lugar para anotar suas aulas. Organizado, intuitivo e com apenas o que você precisa para aproveitar as aulas ao máximo! " +
            "Caderno Roxo está disponível para todos os seus dispositivos para que você possa trocar facilmente durante a aula.",
            technologies: "UIKit (View Code), CoreData, CloudKit, Vision, Regex and NSAttributedText.",
            appStoreLink: "https://apps.apple.com/br/app/purple-notebook/id1535269503",
            gitHubLink: "https://github.com/Pepelelipa/MacroChallenge",
            imagePath: "./assets/CadernoRoxoIcon.png"
        }
    ],
    [
        {
...
const projects = [
    ...
    [
        ...
        {
            name: "Endpoints Requests",
            subtitle: "Um auxiliador para APIs REST.",
            description: "Pacote Swift que usa tipos genéricos pra lidar com respostas recebidas de qualquer requisição HTTP.",
            technologies: "Swift Package, Codable.",
            gitHubLink: "https://github.com/PedroFarina/Endpoints-Requests",
            imagePath: "./assets/SwiftPackage.png"
        }
    ...
    [
        ...
        {
            name: "WWDC 2020",
            subtitle: "Um playground Tower Defense.",
            description: "Playground sobre organização de código usado como submissão para a WWDC2020.",
            technologies: "Swift Playgrounds, Entidade Componente, SpriteKit, GameplayKit.",
            gitHubLink: "https://github.com/PedroFarina/WWDC2020",
            imagePath: "./assets/WWDC2020.png"
        }
    ],
    [
        ...
        {
            name: "UIGameKit",
            subtitle: "Um experimento em UIKit.",
            description: "Uma biblioteca construida usando UIDynamics para criar um sistema que lida com física tentando simular funcionalidades de SpriteKit.",
            technologies: "UIKit.",
            gitHubLink: "https://github.com/PedroFarina/UIGameKit",
            imagePath: "./assets/Swift.png"
        }
    ...
    [
        ...
        {
            name: "Game of Life",
            subtitle: "Um experimento de simulação.",
            description: "Algumas experiências 3D e AR usando um sistema baseado no 'Game of Life' do matemático John Conway",
            technologies: "SceneKit, ARKit, Game Loop, Pool.",
            gitHubLink: "https://github.com/PedroFarina/Game-of-Life",
            imagePath: "./assets/GameOfLife.png"
        }
    ...
    [
        ...
        {
            name: "DataConnector",
            subtitle: "Um auxiliador para CloudKit.",
            description: "Pacote Swift feito para facilitar a conexão com o CloudKit.",
            technologies: "Swift Package, CloudKit.",
            gitHubLink: "https://github.com/PedroFarina/CKDataConnector",
            imagePath: "./assets/SwiftPackage.png"
        }
    ...
    [
        ...
        {
            name: "Sword Clash",
            subtitle: "Um experimento tvOS + Multipeer.",
            description: "Um experimento usando multipeer para conectar dispositivos iOS com tvOS para controlar até duas espadas na TV usando CoreMotion.",
            technologies: "SpriteKit, Multipeer Connectivity, CoreMotion, UIKit (Storyboard).",
            gitHubLink: "https://github.com/PedroFarina/Nano-4",
            imagePath: "./assets/SwordClash.png"
        }
    ...
    [
        {
            ...
            description: "A project designed to help your mental health remembering your friends and who you like going out with. Although we had not even near enoough experience at the time.",
        ...
        {
            name: "Memory Lane",
            subtitle: "Nosso primeiro app.",
            description: "Um projeto pensado para ajudar a avaliar os eventos com seus amigos e cuidar da sua saúde mental. Porém não tínhamos nem perto da experiência possível pra fazer isso.",
            technologies: "UIKit (Storyboard), CoreData.",
            appStoreLink: "https://apps.apple.com/br/app/memory-lane/id1463876327",
            gitHubLink: "https://github.com/PedroFarina/ourSecondApp",
            imagePath: "./assets/MemoryLane.png"
    ...
    [
        {
            ...
            description: "An interactive children's story playgroundbook used as submission to WWDC2019.",
        ...
        {
            name: "Slider",
            subtitle: "Minha primeira experiência em Swift.",
            description: "Um playground book contando uma história infantil interativa usado como submissão para WWDC2019.",
            technologies: "Swift Playgrounds, SpriteKit.",
            gitHubLink: "https://github.com/PedroFarina/Slider",
            imagePath: "./assets/Slider.png"
        }
    ...
    [
        ...
        {
            name: "Este site",
            subtitle: "Um portfólio bonito.",
            description: "Um projeto front-end para me mostrar para você e outras pessoas. Pixel art por: Teguh Andi Raharjo.",
            technologies: "HTML, CSS, JavaScript, Bootstrap.",
            gitHubLink: "https://github.com/PedroFarina/pedrofarina.github.io",
            imagePath: "./assets/PedroPixelArt.png"
        }
